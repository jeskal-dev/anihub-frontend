<script lang="ts">
	...
	import { type LoginSchema } from '$lib/api/validations/authSchema';
	...
	const { form, errors, enhance } = loginForm(data.form);
</script>
	...
	>
		<div class="mb-8 flex flex-col items-center">
			...
			<Motion
				...
				let:motion
			>
				<p use:motion class="text-neutral-400">Inicia sesión y continua la aventura</p>
			</Motion>
		</div>
